...
//con- and destructer
Server::Server(): _epoll_fd(-1), _sock_fd(-1) {}
...
void	Server::process_event(const int& client_sock)
{
	char	buf[513]; //13?	
...
void	Server::failure_exit(const std::string& error_msg)
{
...
//public methods
void	Server::createTcpSocket(const std::string& ip, const int& port) //exits?
{
